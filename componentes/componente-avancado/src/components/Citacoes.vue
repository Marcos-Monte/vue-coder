<template>
    <div class="citacoes">
        ...
        <!-- Componente Citação: Recebendo um 'bind' dinâmico-->
        <!-- <AppCitacao
            :propsAutor="citacoes[indice].autor"
            :propsTexto="citacoes[indice].texto"
            :propsFonte="citacoes[indice].fonte"
        /> -->
